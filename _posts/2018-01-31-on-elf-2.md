...
I'm only going to illustrate one: `HUNK_RELOC32`.
...
There also is a `HUNK_PPC_RELOC26` for PowerPC-related relocations as well.
...
Please note that there is an implicit reference to the most recently loaded segment.
...
Remember that while processing the `HUNK_HEADER`,
