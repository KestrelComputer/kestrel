...
One of the biggest beefs I have with ELF relates to the lack of *normative procedures* concerning how to actually use it.
This brings to mind a quote by Fred Brooks, which reads,
...
Nowhere is this more demonstrable than with ELF vs. just about any other executable format you care to name,
...
With `a.out`, hunk format, et. al. there is a formal structure which makes it clear what you can do with it, and how.

In fact, Eric S. Raymond has written at length about the importance of simplicity in open source software,
...
Needless to say, while researching how to write a dynamic ELF loader for my own project,
that of the Kestrel-3,
...
To this end,
ELF is wasteful because it's over-engineered and under-documented in exactly the ways that it needs to be.
