...
This made sense on a 320x200 display, but it doesn't generally apply with larger displays.
...
While Oberon's user interface may leave many confused,
especially upon first exposure,
...
Moreover, this design lets one build applications without concern
...
Even if the relatively thick stack of compilers and linkers worked perfectly together,
...
one cannot, without exerting great deal of effort,
...
than I'd ever be with C or Forth at this point.
...
so again, that's code I don't have to reinvent myself.
Moreover, at least one VNC client was known to exist for Oberon.
If I can trace the source code for that client and get permission to use it,
then again, less code for me to (re)write.

For those who don't remember,
Ken's Challenge was posed to me by my friend and former coworker,
who I'll just identify as Ken.
