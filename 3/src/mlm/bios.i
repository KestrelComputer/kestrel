...
0
DUP CONSTANT	blicb_buffer		8 +
DUP CONSTANT	blicb_length		8 +
DUP CONSTANT	blicb_capacity		8 +
CONSTANT	blicb_sizeof
...
0
DUP CONSTANT	brod_uart_base		8 +
DUP CONSTANT	brod_initsp		8 +
DUP CONSTANT	brod_bcb		8 +
